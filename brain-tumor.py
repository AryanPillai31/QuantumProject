...
def preprocess_and_save_dataset(train_folder, test_folder, output_folder="preprocessed_braintumor_mri", n_components=100):
...
if __name__ == "__main__":
    train_folder = "brain_tumor_mri/train"
    test_folder = "brain_tumor_mri/test"
    
    if not os.path.exists(train_folder) or not os.path.exists(test_folder):
        print(f"Train or Test folder not found.")
    else:
        preprocess_and_save_dataset(train_folder, test_folder, output_folder="preprocessed_braintumor_mri", n_components=100)
